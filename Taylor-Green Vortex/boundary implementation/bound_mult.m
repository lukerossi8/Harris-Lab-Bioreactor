...
r_i = [90e-6; 90e-6; 90e-6; 90e-6]; % Microcarrier radii, in m
m = [2.79e-9; 2.79e-9; 2.79e-9; 2.79e-9]; % Microcarrier mass, in kg
...
x0 = [0.04; 0.010; 0.100; -0.020]; % Initial x position, m
y0 = [0.04; 0.01; -0.040; -0.030]; % Initial y position, m
s0 = [x0; y0]; % Initial positions, m

vx0 = [0.01; -0.01; 0; 0]; % Initial x velocity, m/s
vy0 = [-0.02; 0.02; 0; 0]; % Initial y velocity, m/s
